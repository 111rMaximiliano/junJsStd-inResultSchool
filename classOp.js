...
juniorDeveloper.learnNewTechnologies("HTML");
juniorDeveloper.learnNewTechnologies("CSS");
juniorDeveloper.learnNewTechnologies("JavaScript");
middleDeveloper.learnNewTechnologies("HTML");
middleDeveloper.learnNewTechnologies("CSS");
middleDeveloper.learnNewTechnologies("JavaScript");
middleDeveloper.learnNewTechnologies("React");
seniorDeveloper.learnNewTechnologies("HTML");
seniorDeveloper.learnNewTechnologies("CSS");
seniorDeveloper.learnNewTechnologies("JavaScript");
seniorDeveloper.learnNewTechnologies("React");
seniorDeveloper.learnNewTechnologies("NodeJS");
