...
//javaScriptDescription = javaScriptDescription.translitCyrToLat() как провести транслитерацию так и не понял, плагин не срабатывает, написал коллегам в дискорд, ответа пока не поучил(за 5+ часов)
